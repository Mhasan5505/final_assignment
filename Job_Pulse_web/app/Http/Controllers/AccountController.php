...
class AccountController extends Controller
{
    ...
    public function upadateProfilePic(Request $request) {
        $id = Auth::user()->id;
...
// create job from here
    ...
    public function saveJob(Request $request) {
        ...
        $validator = Validator::make($request->all(),[
            ...
            'company_location' => 'required|max:75',
        ...
        if ($validator->passes()) {
            ...
            $job->exprrience = $request->exprrience;
    ...
    public function updatePassword(Request $request) {
        ...
        $user->password = Hash::make($request->nwe_password);
        $user->save();
    ...
    public function processResetPassword (Request $request) {
        ...
        return redirect()->route('account.login')->with('success','Change password successfully.');
