            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a style="text-decoration: none" href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a style="text-decoration: none" href="{{ route('admin.jobs') }}">Jobs</a></li>
                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    <option value="1" {{ ($job->experience == 0) ? 'selected' : '' }}>Select a option</option>
